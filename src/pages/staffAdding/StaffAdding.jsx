        ...
        <div>
            ...
            >
                ...
                >
                    ...
                    >
                        <Button
                            sx={{marginTop:'30%',height:'50px', width: '100%', fontSize: '17px' }}
                            variant="contained"
                        >
                            Əlavə et
                        </Button>
            ...
            >
                ...
                >
                    ...
                    <Stack
                        spacing={4}
                        direction="row"
                        sx={{ width: '100%',display:'flex',justifyContent:'flex-end', height: '50px' }}
                    >
                        <Button
                            sx={{marginTop:'3%',height:'50px', width: '30%', fontSize: '17px' }}
                            variant="contained"
                        >
                            Əlavə et
                        </Button>
